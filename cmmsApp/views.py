...
def request_demo_view(request):
    ...
    subject = "New Transmission Line Material inquiry"
    text_body = (
        "A new Transmission Line Material inquiry request was submitted.\n\n"
        f"Submitted: {ts}\n"
    ...
    html_body = f"""
        <h2 style="margin:0 0 8px">New Transmission Line Material Inquiry Request</h2>
...
def contact_section(request):
    ...
    if request.method == "POST" and form.is_valid():
        ...
        # Email body
        subject = "New website contact submission for Transmission Line Material Inquiry"
        text_body = "\n".join(
            [
                "New contact submission for Transmission Line Material Inquiry:",
...
def contact_block_submit(request):
    ...
    text_body = "\n".join([
        "A new consulting request was submitted for Transmission Line Material:",
        f"Name: {name}",
        f"Email: {email}",
